/****** Object:  Function [dbo].[fn_хРеестрУслугиИТМЦ14_R]    Committed by VersionSQL https://www.versionsql.com ******/

-- =============================================
-- Author:		<Kazak>
-- Create date: <20181130>
-- Description:	<Реестр услуг Шлюмберже плюс ТМЦ из операций v14>
-- =============================================
CREATE FUNCTION [dbo].[fn_хРеестрУслугиИТМЦ14_R]
(	
...
from (	
		select	p.Дата [Дата Поручения],
				...
				u.Цена3,
				cast(u.Цена3*(case when u.ЕИК='Тоннаж' then s.Тоннаж when u.ЕИК='Мест' then s.мест else null end) as money) Стоимость3,
