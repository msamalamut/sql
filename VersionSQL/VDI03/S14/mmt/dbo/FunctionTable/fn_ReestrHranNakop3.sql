/****** Object:  Function [dbo].[fn_ReestrHranNakop3]    Committed by VersionSQL https://www.versionsql.com ******/


CREATE FUNCTION [dbo].[fn_ReestrHranNakop3](@project varchar(32), @dn datetime, @dk datetime, @LgotPeriod int)
RETURNS TABLE 
AS
RETURN 
