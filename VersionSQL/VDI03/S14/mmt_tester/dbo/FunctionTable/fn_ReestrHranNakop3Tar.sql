/****** Object:  Function [dbo].[fn_ReestrHranNakop3Tar]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE FUNCTION [dbo].[fn_ReestrHranNakop3Tar]
	(@project varchar(32)
	, @dn datetime
	, @dk datetime
	, @LgotPeriod int
...
--------------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	...
	, a.Операция, a.Номер, a.Транспорт, dbo.fn_SkladPrice(a.Откуда, @numPrice) as цена
	, a.npp, m.Код mtr
	, m.тип ТмцТип
	, m.Маркировка
